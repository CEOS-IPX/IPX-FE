...
function Cell({ index, value, error, ref, ...handlers }: CellProps) {
  return (
    <input
      ...
      className={cn(
        "h-20.5 w-[73.333px] rounded-md border-[1.5px] border-outline-default bg-bg-neutral-hover text-center text-headline-emphasis-32 text-title-secondary focus:outline-none",
